...
export const MaritimeWidget: React.FC<MaritimeWidgetProps> = ({ id, onRemove, onNavigate }) => {
  ...
  const labelFontSize = fontSize.tiny;
  const valueFontSize = fontSize.small;
  const routeNameFontSize = fontSize.tiny;
  const routeDetailFontSize = fontSize.tiny;
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <div
          style={{
            ...
            overflow: 'hidden',
            cursor: 'pointer',
            borderBottom: `2px solid ${colors.accent || '#00FFFF'}`
          }}
        ...
        <div style={{ flex: '0 0 40%', padding: '6px', fontSize: routeDetailFontSize, overflowY: 'auto' }}>
          {/* Intelligence Stats */}
          <div style={{
            display: 'grid',
          ...
          {TRADE_ROUTES.map((route, idx) => (
            ...
            >
              <div style={{
                ...
                <span style={{ color: colors.text || '#FFFFFF', fontSize: routeNameFontSize, fontWeight: 'bold' }}>
                  {route.name}
                </span>
                <span style={{
                  color: getStatusColor(route.status),
                  fontSize: routeDetailFontSize,
                  padding: '1px 2px',
