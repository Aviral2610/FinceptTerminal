...
**Version:**`v3.1.6`\|**Libéré:**2026-01-11

| Plate-forme  | Architecture   | Télécharger                                                                                                                              |
| ------------ | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| **macOS**    | Pomme Silicium | [Télécharger](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-macOS-arm64.dmg)    |
| **macOS**    | Intel          | [Télécharger](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-macOS-x64.dmg)      |
| **Linux**    | x64 (AppImage) | [Télécharger](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Linux-x64.AppImage) |
| **Linux**    | x64 (Debian)   | [Télécharger](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Linux-x64.deb)      |
| **Fenêtres** | hshch          | [Télécharger](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Windows-x64.msi)    |
