...
**バージョン:**`v3.1.6`\|**リリース:**2026-01-11

| プラットフォーム  | 建築            | ダウンロード                                                                                                                              |
| --------- | ------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **macOS** | アップルシリコン      | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-macOS-arm64.dmg)    |
| **macOS** | インテル          | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-macOS-x64.dmg)      |
| **Linux** | x64 (アプリイメージ) | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Linux-x64.AppImage) |
| **Linux** | x64 (Debian)  | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Linux-x64.deb)      |
| **窓**     | ふーん           | [ダウンロード](https://github.com/Fincept-Corporation/FinceptTerminal/releases/download/v3.1.6/FinceptTerminal-v3.1.5-Windows-x64.msi)    |
